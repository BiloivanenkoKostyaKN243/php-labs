<div class="page-home">
    ...
    <div class="card-grid">
        ...
        <div class="card">
            <h3 class="card__title">Space Explorer</h3>
            <p class="card__text">
                Аркадна міні-гра з вибором зоряної системи, переглядом планет
                та невеликим космічним радаром на canvas для ПК і смартфонів.
            </p>
            <a href="index.php?route=game/menu" class="btn btn--small">Запустити</a>
        </div>

        <div class="card">
            <h3 class="card__title">🚀 Space Simulator</h3>
            <p class="card__text">
                Інтерактивний 3D симулятор космоса, натхненний SpaceEngine.
                Дослідіть зоряні системи, обертайте камеру та кліқайте на планети 
                для перегляду інформації.
            </p>
            <a href="index.php?route=space" class="btn btn--small">Запустити</a>
        </div>
    </div>
