...
(1, 'Футболка з логотипом Space Engine', 'Apparel', 699.00, 'Чорна футболка з логотипом міні-гри. Фото можна замінити через редагування товару.', ''),
(2, 'Кепка з логотипом Space Engine', 'Accessories', 449.00, 'Кепка для фанатів Space Engine з місцем під фото логотипу.', ''),
(3, 'Ракета з емблемою Space Engine', 'Collectible', 1299.00, 'Колекційна модель ракети з емблемою міні-гри для космічної полиці.', ''),
(4, 'Стікер-пак космічного пілота', 'Desk Gear', 149.00, 'Набір наліпок з кораблями, планетами та написом Space Engine.', '');

-- Lab 6 Invoices table
...
INSERT OR IGNORE INTO users (login, password, email, first_name, last_name, phone, city, gender, about, role, age) VALUES
    ('admin@admin.com', '$2y$12$TgH78YFWxunnlRjKuNYG2OMgZDRDUxfu5p5qzQhRL66JOVpg3gfEe', 'admin@admin.com', 'Administrator', '', '', 'Orbital Station', 'male', 'Lab 6 administrator.', 'admin', NULL);
